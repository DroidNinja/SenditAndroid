...
public class IntentUtils {
     ...
     * {@link Bitmap}. See demo app for details
     */
    ...
    public static Intent getShareImageIntent(String image_url)
    {
        Intent shareIntent = new Intent(Intent.ACTION_SEND);
        String extraText = "Shared via: Send it!";
        shareIntent.setType("image/*");
        shareIntent.putExtra(Intent.EXTRA_TEXT, extraText);

//        File file = ImageLoader.getInstance().getDiscCache().get(image_url);
//        if (!file.exists()) {
//            DisplayImageOptions options = new DisplayImageOptions.Builder()
//                    .imageScaleType(ImageScaleType.NONE)
//                    .cacheOnDisc()
//                    .build();
//           ImageLoader.getInstance().loadImage(image_url, options, new SimpleImageLoadingListener() {
//               @Override
