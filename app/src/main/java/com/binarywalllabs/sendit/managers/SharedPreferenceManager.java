...
public class SharedPreferenceManager {
    ...
    */
    ...
    public void setDeviceRegistered(boolean isRegister)
    {
        setBooleanInPreferences(AppConstants.SharedPreferenceKeys.DEVICE_REGISTERED.getKey(), isRegister);
    }

    public boolean isDeviceRegistered()
    {
        return getBooleanFromPreferences(AppConstants.SharedPreferenceKeys.DEVICE_REGISTERED.getKey());
    }

    public void setDevicePushToken(String pushToken)
    {
        setStringInPreferences(AppConstants.SharedPreferenceKeys.DEVICE_TOKEN.getKey(), pushToken);
    }

    public String getDevicePushToken()
    {
       return getStringFromPreferances(AppConstants.SharedPreferenceKeys.DEVICE_TOKEN.getKey());
    }
}